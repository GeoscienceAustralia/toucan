...
# Push Both Commits
git.push(ra_remote, '--all')
logging.info('Pushing {0} and {1} branches to {2}'.format(ra_branch_integration, ra_branch_master, ra_remote))

# Push Tags
git.push(ra_remote, '--tags')
logging.info('Pushing new tags to {0}'.format(ra_remote))
